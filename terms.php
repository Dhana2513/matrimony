	...
	<div style="z-index: 10; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: white; position: fixed; top: 0; width: 100%;">
		<div class="topnav" id="myTopnav">
			...
			?>
				...
				<!--<a href="help.php" class="nav_content" style="color: #00A2E8;">Help</a>-->
				<div class="dropdownx">
			...
			?>
				<!--<a href="#" class="nav_content">Help</a>-->
				<div class="dropdownx">
					<button class="dropbtn">Help
						<i class="fa fa-caret-down"></i>
					</button>
		...
		<div class="row" style="margin-top: 100px;">
			<div class="col-md-3" style="margin-bottom: 20px;">
				<div style="background: white; border-radius: 5px;box-shadow: 0 4px 10px rgba(0,0,0,0.15);" class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a style="font-size:19px;" class="nav-link active">Terms and conditions</a>
			...
			<div class="col-md-9" style="">
				<div class="tab-content" id="v-pills-tabContent" style="min-height: 500px; padding: 20px; width: 98%; margin:0 auto;background: white;  border: 0.5px solid #f2f2f2;border-radius: 4px;">
					<div style="" class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
						...
						<h5 style="color: #7f7f7f;">3) For marriage, Male must be 21 years and Female age 18.</h5>
						<h5 style="color: #7f7f7f;">4) Must maintain humility, modesty, modesty.</h5>
						<h5 style="color: #7f7f7f;">5) No sexual Yes Regiment can be made; If any victim, the authorities should be informed properly.</h5>


						<h5 style="color: #7f7f7f;">6) No dishonest way can be taken through the web site. </h5>
						<h5 style="color: #7f7f7f;">7) Male-Female must be legal for marriage in the state. </h5>
						<h5 style="color: #7f7f7f;">8) No ID can be opened in the name of any business organization, organization, agency, company etc. </h5>
						<h5 style="color: #7f7f7f;">9) Advertising is not permitted for any type of business organization, organization, agency or any type. </h5>
						<h5 style="color: #7f7f7f;">10) The authority reserves the right to email, message or call on your personal email id or mobile number. </h5>
						<h5 style="color: #7f7f7f;">11) The authorities should be informed if there is any technical problem. </h5>
						<h5 style="color: #7f7f7f;">12) The authorities are not responsible for any fraud, financial transactions, crime and misinformation. </h5>
						<h5 style="color: #7f7f7f;">13) The Authority reserves the right to store, cancel and exchange all information in your account. </h5>
						<h5 style="color: #7f7f7f;">14) The authority reserves the right to change any decision at any time if necessary. </h5>
						<h5 style="color: #7f7f7f;">15) The authorities have the right to take action against any kind of unwanted / unlawful crime in accordance with local law. </h5>
						<h5 style="color: #7f7f7f;">16) You agree to the terms of the Authority and you are hereby completing the Registration. </h5>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" id="exampleModalLabel" style="color: #00A2E8; text-align: center; margin-left: 15px;">Registerঃ </h3>
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
					<form id="login" method="post" action="">
						...
						<input type="password" required id="pass" class="form-control" name="" placeholder="Enter password ...">
						<br>
