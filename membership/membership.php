				...
				<div class="price-grid">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									...
									<li>Allowed Contacts/Address : 50</li>
						...
						<div class="price-selet pric-sclr1">
							<a class="popup-with-zoom-anim" data-plan="basic" data-price="5.00" href="payment.php?price=1000">Choose</a>
						</div>
					</div>
				</div>
				<div class="price-grid">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									...
									<li>Allowed Contacts/Address : 75</li>
									<!-- <li>Customers Support</li>
											<li>Free Updates</li>
											<li>Unlimited Domains</li> -->
								</ul>
						...
						<div class="price-selet pric-sclr2">
							<a class="popup-with-zoom-anim" data-plan="standart" data-price="10.00" href="payment.php?price=2000">Choose</a>
						</div>
					</div>
				</div>
				<div class="price-grid wthree">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									...
									<li>Allowed Contacts/Address : 100</li>
									<!-- <li>Customers Support</li>
											<li>Free Updates</li>
											<li>Unlimited Domains</li> -->
								</ul>
						...
						<div class="price-selet pric-sclr3">
							<a class="popup-with-zoom-anim" data-plan="premium" data-price="20.00" href="payment.php?price=4000">Choose</a>
						</div>
					</div>
				</div>
				<div class="clear"> </div>
