	...
	<div id="wrapper">
		...
		<div class="row blog_sec">
			...
			<div class="col-md-10" style="margin: 0; padding: 0; min-height: 500px;">
				<a href="posts.php"><button style="margin-top: 60px; margin-bottom: -50px;" class="form-control  btn btn-info">Show All Posts</button></a>
				...
				<div class="" style="margin:0;" id="post_load1">
					<?php
					$qr = "SELECT * FROM posts WHERE id = '$post_id';";
					$rn = mysqli_query($con, $qr);
					//if(mysqli_num_rows($rn)>0){
					$row = mysqli_fetch_array($rn);

					$content = nl2br($row['content']);
					$content1 = mb_substr(nl2br($row['content']), 0, 1300);
					$hisname = $row['name'];
					$image = $row['image'];
					// $gender = $row['gender'];
					...
					?>
						<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
							...
							<div class="row" style="padding: 15px 10px;">
								...
								<div class="col-md-7" style="padding: 10px; max-height: 300px; overflow-y: scroll; position: relative;">
