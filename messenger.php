			...
			<div class="col-md-8" style="margin: 0; padding: 0; height: 600px;">
				<div class="chat_window" >
		            <div class="top_menu">
		                ...
		                <div class="title"><?php echo $receiver_name; ?></div>
		            </div>
		            ...
		            <div class="bottom_wrapper clearfix">
		                ...
		                <form id="pm" method="post" action='' >
		                    <div class="btn-group" style="width: 100%;">
		                        ...
		                        <button id="m_submit" type="submit" class="btn btn-infos" style="margin-left: 10px;">Send <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
		                    </div>
		                </form>               
		            </div>
		        </div>
			</div>
			<div class="col-md-2" style="margin-top:60px;  background: #fff; border-top: 25px solid #E1EFF9; padding: 10px 15px; border-radius: 5px; box-shadow: 0px 6px 14px 0px rgba(0,0,0,0.15); max-height: 480px; overflow-y: scroll; position: relative;">
				...
				<?php
					...
					?>
					<a style="text-decoration: none;" href="messenger.php?us9349y9hfk=<?php echo $user_id;?>"><h5 style="color: #7f7f7f;"><?php echo $name?></h5></a>
