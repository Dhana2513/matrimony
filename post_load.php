...
<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
	...
	<div style="background: #f2f2f2; padding: 10px; border-radius: 10px; width: 100%; margin: 0;" class="btn-group row">
		<div class="col-md-6" style="padding: 0px 10px; margin: 0;">
			<center><a href="comment.php?id=<?php echo $post_id; ?>&title=<?php echo $title;?>" style="text-decoration: none;"><button style="border:none; background: inherit; color: #00A2E8;"><i class="fa fa-comments" aria-hidden="true"></i> Comment</button></a></center>
		</div>
		<div class="col-md-6" style="padding: 0px 10px; margin: 0;">
			<center><a href="comment.php?id=<?php echo $post_id; ?>&title=<?php echo $title;?>" style="text-decoration: none;"><button style="color: #00A2E8;border:none; background: inherit;">See more</button></a></center>
		</div>
