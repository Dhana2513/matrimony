			...
			<div class="col-md-8" style="margin: 0;  margin-top: 40px; padding: 0; ">
				...
				<div class="bio_fil" style="background: white;margin: 0 auto; padding: 10px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); border-radius: 0px 0px 8px 8px;">
					...
					<div style="margin-top: 10px;">
						<button id="show_bio" type="button" class="btn btn-danger form-control" style="font-family: 'Bangla';"><h5>Fill / edit biodata  <i class="fa fa-pencil-square-o" aria-hidden="true"></i></h5></button>
					</div>
					<?php
				        }
					?>
				...
				<div id="bio" class="bio_fil" style="background: white; margin: 0 auto; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); border-radius: 5px; margin-top: 10px;">
					<div class="row" style="padding: 20px 15px;">
						<h3 style="margin-left: 13px; color: #00A2E8; margin-bottom: 10px;">Biodata</h3>
						...
						<div class="col-md-6">
							<form method="post" id="bio_form">
								...
								<h5 style="margin-left: 3px;">Male / Female Name: </h5>
								...
								<input type="text" id="father_work" class="form-control" name="" placeholder="Father পেশা" value="<?php echo $father_work;?>">
								...
								<input type="text" id="mother_work" class="form-control" name="" placeholder="Mother পেশা" value="<?php echo $mother_work;?>">
								...
								<label class="radio-inline"><input required class="gender" type="radio" name="gender"  value="Male"  <?php if($gender=='Male'){echo "checked";} ?>> Male</label>
								<label class="radio-inline"><input type="radio" class="gender" name="gender" value="Female" <?php if($gender=='Female'){echo "checked";} ?>> Female</label>
								...
								<label class="radio-inline"><input required class="religion" type="radio" name="religion" value="Islam"  <?php if($religion=='Islam'){echo "checked";} ?>> Islam</label>
								<label class="radio-inline"><input type="radio" class="religion" name="religion" value="Hindu"  <?php if($religion=='Hindu'){echo "checked";} ?>> Hindu </label>
								...
								<label class="radio-inline"><input type="radio" class="religion" name="religion" value="Buddhist"  <?php if($religion=='Buddhist'){echo "checked";} ?>> Buddhist </label>

								<label class="radio-inline"><input type="radio" class="religion" name="religion" value="Other"  <?php if($religion=='Other'){echo "checked";} ?>> Other</label>
						...
						<div class="col-md-6">
							...
							<label class="radio-inline"><input required class="m_stat" type="radio" name="m_stat"  value="Unmarried"  <?php if($m_stat=='Unmarried'){echo "checked";} ?>> Unmarried</label>
					        <label class="radio-inline"><input type="radio" class="m_stat" name="m_stat" value="Divorced"   <?php if($m_stat=='Divorced'){echo "checked";} ?>> Divorced</label>
					        <label class="radio-inline"><input type="radio" class="m_stat" name="m_stat" value="Widow"  <?php if($m_stat=='Widow'){echo "checked";} ?>> Widow</label>
					        <label class="radio-inline"><input type="radio" class="m_stat" name="m_stat" value="Dangerous"  <?php if($m_stat=='Dangerous'){echo "checked";} ?>> Dangerous</label>
							
							<h5 style=" margin-top: 10px; color: #000;">Do you smoke:</h5>

							<label class="radio-inline"><input  required class="smoking" type="radio" name="smoking"  value="Yes" <?php if($smoking=='Yes'){echo "checked";} ?>> Yes</label>
					        <label class="radio-inline"><input type="radio" class="smoking" name="smoking" value="না" <?php if($smoking=='না'){echo "checked";} ?>> না</label>
					        <label class="radio-inline"><input type="radio" class="smoking" name="smoking" value="At times" <?php if($smoking=='At times'){echo "checked";} ?>> At times</label>
					        
					        <h5 style=" margin-top: 10px; color: #000;">Whether there is a disability:</h5>

							<label class="radio-inline"><input  class="protibondhi" type="radio" name="protibondhi" value="Yes" <?php if($protibondhi=='Yes'){echo "checked";} ?>> Yes</label>
							...
							<label class="radio-inline"><input required class="where" type="radio" name="where" value="India"  <?php if($abroad=='India'){echo "checked";} ?>> India</label>
							<label class="radio-inline"><input type="radio" class="where" name="where" value="Abroad" <?php if($abroad=='Abroad'){echo "checked";} ?>> Abroad </label>
					        ...
					        <textarea id="about_her" rows="4" class="form-control" placeholder="Example: ফর্সা, Nameাজী, পর্দাশীল, শিক্ষিত ও সুন্দর মনের অধিকারী হতে হবে। বয়স ২১ - ২৫ বছর। " value=""><?php if(isset($about_her)){echo $about_her;}?></textarea>
					        

					        <h5 style=" margin-top: 10px; color: #000;">Write something about yourself:</h5>
					        <textarea id="about_me" rows="4" class="form-control" placeholder="Example: শান্ত ও ভদ্র, পাঁচ ওয়াক্ত Nameাজ পড়ি, অন্যকে সাহায্য করার চেষ্টা করি, অবসর সময়ে বই পড়তে ও ভ্রমণ করতে ভালবাসি..." value=""><?php if(isset($about_me)){echo $about_me;}?></textarea>
				...
				<div class="bio_fil" style="background: white;margin: 20px auto; padding: 20px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); border-radius: 5px">
					<h3 style="color: #00A2E8; margin-left: 13px;">Biodata</h3>
					<?php if($user == $member){?>
					...
					?>
							<div class="row" style="padding: 15px;">
								<div class="col-md-6">
									...
									<h5><span style="color:#7f7f7f;">Gender:</span> <?php  if($gender=="Male"){echo "Male";}else{echo "Women";} ?></h5>
	...
	$("#bio_form").submit(function(){
		...
		return false;
			...
			<div class="col-md-2" style="margin-top:40px;  background: #fff; border-top: 25px solid #00A8EC; padding: 10px 15px; border-radius: 5px; box-shadow: 0px 6px 14px 0px rgba(0,0,0,0.15); max-height: 500px; overflow-y: scroll; position: relative;">
				<h3 style="color: #11CFFA;">Members:</h3>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
			      		<h4 style="text-align: center;">Registrationের জন্য ধন্যবাদ</h4>
			...
			<div class="modal-dialog" style="">
				<div class="modal-content" style="padding: 20px 30px;">
	        		...
	        		<h3 class="" style="color: #FF8D8D; text-align:center;">স্বাগতম</h3>
		      		...
		      		<h4 style="text-align: center; color: #5BBC2E;">Registrationের জন্য ধন্যবাদ</h4>
			      	<h5 style="text-align: center;">আপনার বায়োডাটা টি পূরণ করুন</h5>
