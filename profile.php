				...
				<div class="bio_fil" style="background: white;margin: 0 auto; padding: 10px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); border-radius: 0px 0px 8px 8px;">
					...
					?>
						<div style="margin-top: 10px;">
							<button id="show_bio" type="button" class="btn btn-danger form-control" style="font-family: 'Bangla';">
				...
				<div id="bio" class="bio_fil" style="background: white; margin: 0 auto; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); border-radius: 5px; margin-top: 10px;">
					<div class="row" style="padding: 20px 15px;">
						...
						<div class="col-md-6">
							...
							<input type="text" required id="cur_address" name="" class="form-control" placeholder="Ex: Kharadi, Pune" value="<?php echo $cur_address; ?>">

							<h5 style=" margin-top: 10px; color: #000;">Permanent address:</h5>
							<input type="text" required id="per_address" name="" class="form-control" placeholder="Ex: Kharadi, Pune" value="<?php echo $per_address; ?>">
							...
							<!-- <div class="form-inline">
								<select id="jsc" class="form-control" style="width:80px;">
									<option value="JSC" <?php if ($jsc == 'JSC') {
															echo "selected";
														} ?>>JSC</option>
									<option value="JDC" <?php if ($jsc == 'JDC') {
															echo "selected";
														} ?>>JDC</option>
								</select>
							...
							<input type="text" name="" id="last_ins" placeholder="Ex: BSc in Mechanical Engineering, RUET" class="form-control" value="<?php if (isset($last_ins)) {
																																							echo $last_ins;
																																						} ?>">
							...
							<button class="btn btn-infos" type="submit" id="b_bio" style="margin-top: 10px; font-family: 'Bangla', sans-serif;">Submit</button>
							</form>
							<div id="success">
