 ...
 <?php }?>
			...
			<div class="col-md-9" style="margin: 0; padding: 0;">
				<?php
					if(isset($_SESSION['user'])){
				?>
				<button type="button" id="post_now" style="font-family: 'Bangla', sans-serif; margin-top: 60px; margin-bottom: -50px; font-weight: bold;" class="btn btn-info form-control">Post</button>
			<?php } ?>
				...
				<div class="b_posts" id="post_area">
					...
					<form method="post" action="" enctype="multipart/formdata">
						...
						<input type="text" required id="title" name=""  onfocusout="name_func2(this.value)" class="form-control" onfocus="name_func()" autocomplete="off" placeholder="Enter the title of the post" onkeyup="dunc()">
        			...
        			<script>
						...
						<textarea rows="10" class="form-control" required id="post_content" placeholder="Enter your post here ..."></textarea>
						<br>
						<button type="submit" id="submit_post" class="btn btn-info" style="font-family: 'Bangla', sans-serif;">Post</button>
					</form>
					<div id="result">
			    ...
			    <div class="modal-content" style="padding: 0">
			      ...
			      <div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
			       	<form id="registration_form" class="" method="post">
						...
						<input type="text" required id="name" class="form-control" name="" placeholder="Enter your full name">
						...
						<label for="rules"><a href="help.php">Terms and conditions</a> I have read and agreed</label> 
						<div id="result"></div>      
