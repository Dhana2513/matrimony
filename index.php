				...
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100 img_slider" src="img/dt11.jpg" alt="First slide">
							<div class="carousel-caption d-none d-md-block">

							</div>
						</div>
						<div class="carousel-item">
							<img class="d-block w-100 img_slider" src="img/dt12.jpg" alt="Second slide">
							<div class="carousel-caption d-none d-md-block">
						...
						<div class="carousel-item">
							<img class="d-block w-100 img_slider" src="img/dt10.jpg" alt="Third slide">
							<div class="carousel-caption d-none d-md-block">
			...
			?>
				...
				<div class="login col-md-4">
					...
					<a href="message_notification.php">
						<h5 style="color: #7f7f7f; text-align: center; font-weight: bold;">Messages <span id="no_m" onload="ajaxy()" class="badge badge-primary badge-pill"></span></h5>
					</a>
					<hr>
					<a href="comment_notification.php">
						<h5 style="color: #7f7f7f; text-align: center; font-weight: bold;">Notificaion <span id="no_m2" class="badge badge-danger badge-pill"></span></h5>
					</a>
				</div>
			<?php
			} else {
			...
			?>
				<div class="sp3 section3">
					...
					?>
								...
								<div class="">
									<a href="profile.php?us1031gdh312k=<?php echo $user_id; ?>">
										<h5 style="color: #7f7f7f;"><?php echo $mem_name; ?></h5>
									</a>
