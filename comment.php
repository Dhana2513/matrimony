...
?>
			<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
				<div class="row" style="background: #f9f9f9; padding: 4px 5px; padding-top: 10px;">
					...
					<div class="col-md-8 f_name">
						<h4 style="padding: 5px;"><a style="text-decoration: none; color: #00A2E8;" href="profile.php?us1031gdh312k=<?php echo $poster; ?>"><?php echo $name;?></a></h4>
					</div>
			...
			<?php if(isset($_SESSION['user'])){ ?>
			<div style="box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: #f2f2f2; margin: 0; padding: 10px 19px;">
				<form method="post" action="" id="comment_form">
					<div class="btn-group" style="width: 100%;">
						<input type="text" required id="comments" name="" class="form-control" placeholder="Type your comment here..." autocomplete="off">
						...
						<button id="s_comment" type="submit" class="btn btn-light" style="color: #00A2E8;"><img src="commen.png" width="25"></button>
					</div>
				</form>
			</div>
			<?php
			...
			?>
			<div id="show_comment" onload="ajax1()" style="box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: #f9f9f9; margin: 0; padding: 10px 20px; border-radius: 4px;">
...
?>
			<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
				<div class="row" style="background: #f9f9f9; padding: 4px 5px; padding-top: 10px;">
					...
					<div class="col-md-8 f_name">
						<h4 style="padding: 5px;"><a href="profile.php?us1031gdh312k=<?php echo $poster; ?>" style="text-decoration: none; color: #00A2E8;"><?php echo $name;?></a></h4>
					</div>
					<div class="col-md-3 time">
						<h6 style="color: #7f7f7f;"><?php echo $time;?></h6>
						<h6 style="color: #7f7f7f;"><?php echo $date; ?></h6>
			...
			<div style="box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: #f2f2f2; margin: 0; padding: 10px 19px;">
				<form method="post" action="" id="comment_form">
					<div class="btn-group" style="width: 100%;">
						<input type="text" required id="comments" name="" class="form-control" placeholder="Type your comment here...">
						<input type="hidden" id="commenter" name="" value="<?php echo $user; ?>">
			    ...
			    <div class="modal-content" style="padding: 0">
			      ...
			      <div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
			       	<form id="registration_form" class="" method="post">
						...
						<label for="rules"><a href="help.php">Terms and conditions</a> আমি পড়েছি এবং সম্মত হয়েছি</label> 
						<div id="result"></div>      
