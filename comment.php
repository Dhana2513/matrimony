			    ...
			    <div class="modal-content" style="padding: 0">
			      ...
			      <div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
			       	<form id="registration_form" class="" method="post">
						...
						<label for="rules"><a href="help.php">Terms and conditions</a> Terms and conditions</label> 
						<div id="result"></div>      
						<button class="btn btn-info form-control" id="regbtn" style="font-family: 'Bangla'">Open an account</button>
					</form>
